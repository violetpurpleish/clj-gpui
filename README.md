...
GPUI Kit 0.6 coverage and remaining native extension gaps are recorded in the [source parity audit](docs/gpui-kit-parity.md). See [widget composition](docs/widget-composition.md) for child/slot APIs, [editor configuration and providers](docs/editor-providers.md), and [binding contract notes](docs/gpui-component.md).
